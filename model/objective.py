...
def add_objective_function(model, sets, params, vars):
    ...
    obj_cost_operations_validation = quicksum(task_performed[e, v, p, m] * cost_repair[m] for e in locations for v in ctvessels for p in periods for m in tasks)
    ...
    model.setObjective(
        ...
        # + obj_cost_operations
        + obj_cost_operations_validation
